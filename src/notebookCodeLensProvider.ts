 ...
 * We disable the MSSQL code lens while a notebook is active and provide our
 * own that reflects the actual notebook connection.
 */
export class NotebookCodeLensProvider
    implements vscode.CodeLensProvider, vscode.Disposable
{
    private readonly _onDidChangeCodeLenses = new vscode.EventEmitter<void>();
    public readonly onDidChangeCodeLenses = this._onDidChangeCodeLenses.event;

    private readonly connections: Map<string, ConnectionManager>;
    private readonly disposables: vscode.Disposable[] = [];

    constructor(connections: Map<string, ConnectionManager>) {
    ...
    provideCodeLenses(
        ...
        if (mgr?.isConnected()) {
            ...
            return [
                new vscode.CodeLens(range, {
                    ...
                    command: "sqlNotebooks.changeDatabase",
        ...
        return [
            new vscode.CodeLens(range, {
                ...
                command: "sqlNotebooks.changeConnection",
            }),
        ];
    }

    private findNotebookForCell(
        cellDoc: vscode.TextDocument,
